...
interface solve (Sec.~\ref{sec:subcycle}). This note records the evidence,
the theory, the phased redesign, and the validated fixes.
\end{abstract}
...
Genuine interpolation wins decisively at mesh contrast, where end-sampling
aliases the fine side's intra-window motion into the exchanged traction
($-20.6 \to -14.1\%$). It \emph{loses} slightly on the conforming implicit
...
al.\ 2023), remains follow-up work.
