...
$\mathrm{CFL}=1$. This note records the evidence, the theory, the phased
redesign, and the validated fixes.
\end{abstract}
...
Three observations. First, the conforming and $1{:}0.9$ columns with an
...
included, ending with the staggered metric near $-2\,E_0$. The end state
