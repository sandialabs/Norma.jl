...
\begin{description}[style=unboxed,leftmargin=0pt,itemsep=2pt]
  \item[Phase 1 --- adjoint-paired variational transfer.] Per Schwarz boundary,
  assemble the variational cross-mass $~B$ of \eqref{eq:adjoint} on the common
...
(variational multiplier) field on each Schwarz boundary with both sides coupling to it
