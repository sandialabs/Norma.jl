...
nor transfer improvements (Phase~1) can close at fixed $h$. Mesh conformity
therefore remains the only route to energy conservation \emph{within the
overlap family}; nonconforming overlaps buy geometric flexibility at the price
of controlled, attributable interface dissipation, now reported by the
channel-resolved instrumentation.
