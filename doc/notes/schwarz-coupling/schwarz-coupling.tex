...
boundaries and with their energy behavior. Norma.jl supports two geometric
configurations.
...
Norma.jl sets $c_v = 0$ and the impedance condition reduces to the Robin
...
by rerunning the instrumented case.}
