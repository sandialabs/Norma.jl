...
$\alpha$ remains an optional input parameter.
...
($\norm{~F} = 0.44$), and is provably dissipative (asserted in test 105). \textbf{Its measured effect is null}: the absorber dissipates
...
\item the pair shares one impedance --- the harmonic mean
  ...
  $Z_k = \rho_k c_{p,k}$, the Riemann-solver weighting
...
data, the Robin parameter is \emph{prescribed} in the input
...
traction follows. (Enabling this exposed a progressive time-step reduction defect in the
