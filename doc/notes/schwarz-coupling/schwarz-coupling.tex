...
discrete dashpot term is not a quadratic form. The net of the third row
does not match the $-44.5\%$ ($\approx -670$\,J) of
Table~\ref{tab:drift-1ms}: the instrumented runs were performed separately
from the sweep, and this difference is unreconciled.}
...
nonconf.\ 0.0127, 1:0.75 (pointwise) & $-515$\,J & $-877$\,J & $+341$\,J & $\sim 16$ \\
