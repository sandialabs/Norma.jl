...
two phases accept 76 and 18 operations and end at 9012 elements. The
energy goes from $3.01$ after the first smoothing to $2.24$ at the end;
the remaining value is the size mismatch of the edges that the band
$[0.08/\sqrt2, 0.08\sqrt2]$ accepts, since an edge of $0.12$ is split
once into halves of $0.06$ that are inside the band. The test with a
target of $0.24$ shows the opposite: the short edges are collapsed, the
count falls, and the boundary stays closed and covered by the side sets.
