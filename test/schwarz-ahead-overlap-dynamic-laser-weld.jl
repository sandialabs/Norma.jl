...
@testset "Schwarz AHeaD Overlap Dynamic Laser Weld" begin
    ...
    @test max_disp_z_holder0 ≈ 0.00020594161227460822 atol = 1e-6
    @test min_disp_x_gauge ≈ -6.11625728770826e-5 atol = 1e-6
    @test min_disp_y_gauge ≈ -0.0005587147296370887 atol = 1e-6
    @test min_disp_z_gauge ≈ 2.3880604363396563e-5 atol = 1e-6
