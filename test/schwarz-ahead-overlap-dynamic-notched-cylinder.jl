...
@testset "Schwarz AHeaD Overlap Dynamic Notched Cylinder" begin
    ...
    println("min_disp_x_1 = ", min_disp_x_1, "\n")
    println("min_disp_y_1 = ", min_disp_y_1, "\n")
    println("max_disp_z_1 = ", max_disp_z_1, "\n")
    println("min_disp_x_2 = ", min_disp_x_2, "\n")
    println("min_disp_y_2 = ", min_disp_y_2, "\n")
    println("min_disp_z_2 = ", min_disp_z_2, "\n")
    println("avg_stress_1 = ", avg_stress_1, "\n")
    println("avg_stress_2 = ", avg_stress_2, "\n")
    ...
    @test avg_stress_2 ≈ [-101340.89672529901 -101446.28712096746 1.5977255795638144e6 121800.33493609141 122483.30918545111 37064.478126464295]
