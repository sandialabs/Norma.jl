...
@testset "NN Opinf Schwarz Overlap Dynamic Cuboid Hex8 Same Step" begin
    ...
    rm("ml-models")
    @test model_coarse.reduced_state[1] ≈ -0.0014463385305821307 rtol = 1.0e-06
    @test model_coarse.reduced_state[2] ≈ -0.002624416693803737 rtol = 1.0e-06
    @test model_coarse.reduced_state[3] ≈ 0.001623921415383773 rtol = 1.0e-06
end
