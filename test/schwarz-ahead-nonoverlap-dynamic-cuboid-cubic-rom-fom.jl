...
@testset "Schwarz AHeaD Non-Overlap Dynamic Cuboid HEX8-HEX8 Cubic ROM-FOM" begin
    ...
    @test min_disp_x_cuboid1 ≈ -0.118669293796415 atol = 1e-8
    @test min_disp_y_cuboid1 ≈ -0.11944087500513446 atol = 1e-8
    @test max_disp_z_cuboid1 ≈ 0.5003146066831036 atol = 1e-8
    @test min_disp_x_cuboid2 ≈ -0.11881846728031771 atol = 1e-8
    @test min_disp_y_cuboid2 ≈ -0.11912156627309634 atol = 1e-8
    @test max_disp_z_cuboid2 ≈ 1.0  atol = 1e-8
 
    @test avg_stress_cuboid1 ≈
        [123014.12337378766 -261266.61555121385 5.212968538573105e8 80796.71338002027 -29258.257929767748 -522.8285401074658] atol =
        1.0e1
    @test avg_stress_cuboid2 ≈
        [36403.412050944076 -75496.40418984006 5.2083418589400053e8 57065.73395072571 -36737.03807122002 -1903.3412837164553] atol =
        1.0e1
