...
@testset "Schwarz AHeaD Non-Overlap Dynamic Cuboid HEX8-HEX8 Quadatic ROM-FOM" begin
    ...
    @test min_disp_x_cuboid1 ≈ -0.11865908715700824 atol = 1e-8
    @test min_disp_y_cuboid1 ≈ -0.11947029144901436 atol = 1e-8
    @test max_disp_z_cuboid1 ≈ 0.5003057180466786 atol = 1e-8
    @test min_disp_x_cuboid2 ≈ -0.11882440403358971 atol = 1e-8
    @test min_disp_y_cuboid2 ≈ -0.11912525934776128 atol = 1e-8
    @test max_disp_z_cuboid2 ≈ 1.0  atol = 1e-8
 
    @test avg_stress_cuboid1 ≈
        [145882.79058603974 -267858.17573017784 5.2127194592182404e8 86026.8620319419 -39487.902183254686 -464.7278087427689] atol =
        1.0e1
    @test avg_stress_cuboid2 ≈
        [43082.246360333505 -69367.02606898801 5.208597853368657e8 53154.71204275455 -39736.48695671271 -1615.4486376774705] atol =
        1.0e1
