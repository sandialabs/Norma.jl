...
@testset "AHeaD Single Overlap Dynamic Plate HEX8" begin
    ...
    @test max_disp_z ≈ 0.0020763045671660244 atol = 1e-6
    @test avg_stress ≈ [3.4463447201854037e6 -439317.2493568888 826668.2107678552 5.351041909307241e-6 3.4931994442008644e7 -2.3629205922285715e-8] atol = 1e1
end
