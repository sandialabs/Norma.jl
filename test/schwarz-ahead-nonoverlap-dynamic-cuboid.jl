...
@testset "Schwarz AHeaD Non-Overlap Dynamic Cuboid HEX8-HEX8 FOM-FOM" begin
    ...
    @test max_disp_z_cuboid1 ≈ 0.5000002261644869 atol = 1e-8
    @test min_disp_x_cuboid2 ≈ -0.16666692338319236 atol = 1e-8
    @test min_disp_y_cuboid2 ≈ -0.1666669233831922 atol = 1e-8
    @test max_disp_z_cuboid2 ≈ 1.0  atol = 1e-8
    @test avg_stress_cuboid1 ≈
        [-384.9755137866596 -384.97551380008616 6.666665599451523e8 -63.49887112400637 -63.49887123599481 -35.92214880213098] atol =
        1.0e1
    @test avg_stress_cuboid2 ≈
        [-386.9973080791533 -386.99730793456547 6.666662595534755e8 -30.59894985203704 -30.598949812470888 -6.773960251595678] atol =
        1.0e1
