...
@testset "Schwarz AHeaD Non-Overlap Dynamic Torsion HEX8-HEX8" begin
    ...
    @test avg_stress_torsion1 ≈ [1.7705537665662847e6 1.7706066742399093e6 736180.8008143709 -238.39535563270692 365.22587280095036 -2.557130848843019] atol = 1e-12
    @test avg_stress_torsion2 ≈ [1.4257262240109073e6 1.4257762858988189e6 549384.8122747836 -69.31989121219449 81.6909752368978 -20.893920474565377] atol = 1e-12
    @test sim.controller.schwarz_iters ≈ [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2, 2, 2, 3, 3, 3, 3, 3, 3, 3, 3, 3, 2, 2, 2, 2, 2, 2, 3] atol = 0
