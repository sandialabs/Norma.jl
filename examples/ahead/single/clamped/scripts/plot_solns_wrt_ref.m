...
for i=0:100:10000
  if (i < 10)
    ...
    time1_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-time-000', num2str(i), '.csv');
    disp2_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-disp-000', num2str(i), '.csv');
    velo2_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-velo-000', num2str(i), '.csv');
    acce2_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-acce-000', num2str(i), '.csv');
  elseif (i < 100)
    ...
    disp2_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-disp-00', num2str(i), '.csv');
    velo2_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-velo-00', num2str(i), '.csv');
    acce2_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-acce-00', num2str(i), '.csv');
  elseif (i < 1000)
    ...
    disp2_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-disp-0', num2str(i), '.csv');
    velo2_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-velo-0', num2str(i), '.csv');
    acce2_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-acce-0', num2str(i), '.csv');
  else
    ...
    disp2_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-disp-', num2str(i), '.csv');
    velo2_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-velo-', num2str(i), '.csv');
    acce2_file_name = strcat('../../dynamic-opinf-fom-neohookean/01-acce-', num2str(i), '.csv');
  end
