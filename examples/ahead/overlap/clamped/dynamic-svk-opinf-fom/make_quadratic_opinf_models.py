...
if __name__ == "__main__":
    ...
    # Construct an opinf "HAB" model (linear in the state and linear in the exogenous inputs)
    #   Note: I don't construct a cHAB ROM in this example since I know there is no forcing vector
    ...
    np.savez('quadratic-opinf-operator',**vals_to_save)
