...
function overlap_partners(subsim::SingleDomainSimulation)
    ...
    for bc in model.boundary_conditions
        bc isa SolidMechanicsOverlapSchwarzBoundaryCondition || continue
...
function partner_schwarz_side_set(bc::SolidMechanicsOverlapSchwarzBoundaryCondition, partner_model::SolidMechanics)
    for partner_bc in partner_model.boundary_conditions
        if partner_bc isa SolidMechanicsOverlapSchwarzBoundaryCondition &&
